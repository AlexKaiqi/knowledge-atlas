  ...
  return shell({
    ...
    body: `<div class="page">${head("SMALL CONTRIBUTIONS, SHARED UNDERSTANDING", "你不必是专家，才可以贡献。", "一句更清楚的解释、一个不同的例子、一条能复现的观察，都可能帮助下一个人。")}<div class="three-grid">${[
      [
        ...
        "从一个问题开始",
        "说出你卡在哪里，或者给出一种不同解释。",
        "../community/index.html?compose=question",
        "提出问题",
      ],
      [
        "edit",
      ...
      .join(
        "",
      )}</div><div class="two-columns section"><section class="panel"><h2>把新知识沉淀成一个学习单元</h2><p>你可以先提交未完成的想法。准备成为完整导学时，用这张清单检查；下面的自查只作为临时草稿，不代表通过审阅。</p><ul class="checklist" data-author-checklist>${m.checklist.map((c) => `<li><input type="checkbox" id="check-${c.id}"><label for="check-${c.id}"><b>${c.title}</b><br>${c.human}</label></li>`).join("")}</ul><div class="actions"><button class="button primary" data-download-template>下载知识引入模板</button><span class="meta" data-checklist-status>尚未自查</span></div></section><aside><section class="guide-panel"><h3>自由贡献与正文发布</h3><p>自由讨论欢迎不完整的想法；完整导学需提供学习目标、来源、分层解释、活动、反馈与迁移练习。</p><p>提案公开保留，维护者审阅后合入内容库。未合入的提案不改变知识正文。</p><a href="../method/index.html#checklist" class="inline-link">检查标准从哪里来？</a></section><section class="panel section"><h3>愿意直接改进项目？</h3><p>内容与页面分开维护。仓库提供内容模板、自动校验和发布规范。</p><a class="button small section" href="https://github.com/AlexKaiqi/knowledge-atlas" target="_blank" rel="noreferrer">打开项目仓库 ↗</a></section></aside></div><script type="application/json" data-methods-data>${scriptJson(m)}</script></div>`,
  });
}
